...
#define COLOR_SPECIALGOLD 0xD8C173FF
...
//nowe kolory:
	...
	#define COLOR_LIGHTMINT 0xFFC0CB
	...
	#define COLOR_SANTOSGOLD 0xFFF9CC00
	#define COLOR_ADMINCHAT  0x7AA1C9FF
	#define ADMIN 				"{FF6A6A}"
	#define MAPA 				"{88FFFF}"
	#define AC 					"{FF80C0}"
	#define BIALY 				"{FFFFFF}"
...
#define INCOLOR_SANTOSGOLD  "{f9cc00}"
